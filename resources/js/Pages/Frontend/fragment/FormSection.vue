<template>      
    <section class="pb-[100px] p-4 bg-[#fff]">
        <div class="max-w-[1200px] m-auto mt-10 lg:grid grid-cols-2 gap-[100px] ">
            <div class="">
                <img class="min-h-[800px] rounded-xl object-center object-cover" src="../img/picture6.jpg" alt="">
            </div> 
                ...
                <div>
                    <div class="flex gap-6 mb-4 ">
                        <div class="w-[50%]">
                            ...
                            <span class="text-red-500" v-if="form.errors.first_name">{{ form.errors.first_name }}</span>
                        </div>
                        <div class="w-[50%]">
                            ...
                            <span class="text-red-500" v-if="form.errors.last_name">{{ form.errors.last_name }}</span>
                        </div>
                    </div>  
                    <div class="mt-4">
                    ...
                    <div class="mt-4">
                        ...
                        <span class="text-red-500" v-if="form.errors.company">{{ form.errors.company }}</span>
                    </div>
                    <div class="mt-4">
