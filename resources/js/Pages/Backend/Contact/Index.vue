<template>
    <Master>
        <div className="flex justify-between p-5 bg-white">
            <p className="text-2xl font-bold text-black">Contacts</p>
        </div>
        <div class="pb-4 px-1">
            <div class="">
                        ...
                        <table class="w-full text-sm text-left text-gray-500">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" class="px-2 py-2">First Name</th>
                                    <th scope="col" class="px-2 py-2">Last name</th>
                                    <th scope="col" class="px-2 py-2">Email</th>
                                    <th scope="col" class="px-2 py-2">Company</th>
